...
def main():
    ...
    # PART 2
    # The second check is slightly more complicated: you need to find the value of the root node (A in the example
    # above).
    #
    ...
    # node A's first child node, B, and the 2 references node A's second child node, C. Because node B has a value of
    #  33 and node C has a value of 0, the value of node A is 33+33+0=66.
    #
