...
def main():
    ...
    # including its size as a third parameter after the top-left coordinate: a 9x9 square with a top-left corner of
    # 3,5 is identified as 3,5,9.
    #
    # For example:
    #
    # For grid serial number 18, the largest total square (with a total power of 113) is 16x16 and has a top-left
    # corner of 90,269, so its identifier is 90,269,16. For grid serial number 42, the largest total square (with a
    # total power of 119) is 12x12 and has a top-left corner of 232,251, so its identifier is 232,251,12.
    #
